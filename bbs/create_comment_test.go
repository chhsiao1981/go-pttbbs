...
func TestCreateComment(t *testing.T) {
	...
	expected0 := []byte("\x1b[1;37m\xb1\xc0 \x1b[33mSYSOP\x1b[m\x1b[33m: test123                                                  \x1b[m 05/26 10:25\n")
	...
	tests := []struct {
		...
		{
			args:            args{userID: "SYSOP", boardID: "10_WhoAmI", articleID: articleID, commentType: ptttype.COMMENT_TYPE_RECOMMEND, content: content0, ip: "127.0.0.1"},
