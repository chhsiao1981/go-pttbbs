...
func config() {
	...
	FROMD_ADDR = setStringConfig("FROMD_ADDR", FROMD_ADDR)

	REGMAILD_ADDR = setStringConfig("REGMAILD_ADDR", REGMAILD_ADDR)

	ANGELBEATS_ADDR = setStringConfig("ANGELBEATS_ADDR", ANGELBEATS_ADDR)
	ANGELBEATS_PERF_MIN_PERIOD = setIntConfig("ANGELBEATS_PERF_MIN_PERIOD", ANGELBEATS_PERF_MIN_PERIOD)

	BRCSTORED_ADDR = setStringConfig("BRCSTORED_ADDR", BRCSTORED_ADDR)

	COMMENTD_ADDR = setStringConfig("COMMENTD_ADDR", COMMENTD_ADDR)
	COMMENTLEN = setIntConfig("COMMENTLEN", COMMENTLEN)

	POSTD_ADDR = setStringConfig("POSTD_ADDR", POSTD_ADDR)
	...
	// entropy
	POST_MONEY_RATIO = setDoubleConfig("POST_MONEY_RATIO", POST_MONEY_RATIO)
	USE_POST_ENTROPY = setBoolConfig("USE_POST_ENTROPY", USE_POST_ENTROPY)
	ENTROPY_RATIO = setDoubleConfig("ENTROPY_RATIO", ENTROPY_RATIO)

	// hidden-board
	USE_HIDDEN_BOARD_NOCREDIT = setBoolConfig("USE_HIDDEN_BOARD_NOCREDIT", USE_HIDDEN_BOARD_NOCREDIT)
}
