...
func GetPostTemplate(uuserID UUserID, bboardID BBoardID, templateID int, retrieveTS types.Time4, isHash bool) (content []byte, mtime types.Time4, sum cmsys.Fnv64_t, err error) {
